...
export default function Listing() {
    ...
    return <main>
            ...
            {shareLinkCopied && (
            <p className='fixed top-[23%] right-[5%] font-semibold border-2 border-gray-400 rounded-md bg-white z-10 p-2 text-slate-600'>Link Copied</p>
            )}
            ...
            <div className='m-4 flex flex-col md:flex-row max-w-6xl lg:mx-auto p-4 rounded-lg shadow-lg bg-white lg:space-x-5'>
                <div className='w-full '>
                    ...
                    <div className='flex justify-start items-center space-x-4 w-[75%]'>
                        ...
                        {listing.offer && (
                            <p className='bg-green-800 w-full max-w-[200px] rounded-md pt-1 pb-1 text-white text-center font-semibold shadow-md'>${(+listing.regularPrice - +listing.discountedPrice)
                                .toString()
                    ...
                    <ul className='flex items-center sm:space-x-2 space-x-10 text-sm font-semibold mb-6'>
